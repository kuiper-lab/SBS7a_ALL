...
coldata <- coldata[!rownames(coldata) %in% metadata_subtypes$SKION[metadata_subtypes$Sub.type == "iAMP21 B-ALL"],]
count_matrix <- count_matrix[, rownames(coldata)]
...
write.table(DEgenes_df, "~/Projects/hypermutated_ALL/ANALYSES/RNAseq/DEanalysis_06022026/DEgenesHyperdiploidvsFusiondriven.tsv")
...
write.table(gse_df, "~/Projects/hypermutated_ALL/ANALYSES/RNAseq/DEanalysis_09022026/GSEAHyperdiploidvsFusiondriven.tsv")
