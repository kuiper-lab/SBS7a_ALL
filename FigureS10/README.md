...
## P0624LineageTree.R
This script uses the output of CellPhyWrapper to generate a lineage tree. It extracts mutational signatures from each branch and plots the contributions on the tree (Figure S10A). It also plots the mutational profiles and allele frequencies for SBS7a-positive branches (Figure S10B,S10C). Additionally, it plots some branch-specific quality metrics (Figure S9).
